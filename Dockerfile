...
COPY --chown=sharkey:sharkey --from=build /sharkey/assets/emojis/fluent-emojis ./fluent-emojis
COPY --chown=sharkey:sharkey --from=build /sharkey/assets/emojis/tossface-emojis/dist ./tossface-emojis/dist
