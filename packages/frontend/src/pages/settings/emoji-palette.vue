		...
		<SearchMarker :keywords="['emoji', 'default', 'like', 'react']">
			<FormSection>
				...
				<div class="_buttons" style="padding-top: 8px;">
					<MkButton rounded :small="true" inline :ariaLabel="i18n.ts.chooseEmoji" @click="chooseNewLike"><i class="ph-smiley ph-bold ph-lg"></i> {{ i18n.ts.chooseEmoji }}</MkButton>
					<MkButton rounded :small="true" inline :ariaLabel="i18n.ts.reset" @click="resetLike"><i class="ph-arrow-clockwise ph-bold ph-lg"></i> {{ i18n.ts.reset }}</MkButton>
				</div>
			</FormSection>
		</SearchMarker>
